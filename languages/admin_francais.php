...
$lang['IndexMultibyteUsage'] = 'Notez s\'il vous plaît que vous utilisez actuellement une traduction écrite dans une police de caractères de multioctet (%s). Ces traductions et polices de caractères ne sont pas officiellement soutenus sur UseBB 1';
...
$lang['ConfigBoard-avatars_force_height'] = 'Hauteur max. des avatars (px)';
$lang['ConfigBoard-avatars_force_height-info'] = 'Z&eacute;ro pour non-limit&eacute;.';
$lang['ConfigBoard-avatars_force_width'] = 'Largeur max. des avatars (px)';
$lang['ConfigBoard-avatars_force_width-info'] = 'Z&eacute;ro pour non-limit&eacute;.';
...
$lang['ConfigBoard-posts_per_page'] = 'Messages par page';
...
$lang['ConfigBoard-show_edited_message_timeout-info'] = 'Quand le message, qui vient d\'&ecirc;tre plac&eacute; sur le forum, est modifi&eacute; dans l\'intervalle ci-dessus (en secondes), la note t&eacute;moignant d\'une modification du message reste cach&eacute;e.';
$lang['ConfigBoard-topicreview_posts'] = 'Nombre de messages dans la liste du sujet'; /* ???????????????????????? */
...
$lang['ConfigBoard-enable_rss_per_forum'] = 'Permettez le RSS au forum séparé';
$lang['ConfigBoard-enable_rss_per_topic'] = 'Permettez le RSS au topic séparé';
$lang['ConfigBoard-enable_stafflist'] = 'Autoriser le listing du staff.';
...
$lang['ConfigBoard-return_to_topic_after_posting'] = 'Retourner au sujet apr&egrave;s l\'envoi du message';
...
$lang['ConfigBoard-edit_post_timeout'] = 'Intervalle de temps pour pouvoir &eacute;diter son message';
$lang['ConfigBoard-edit_post_timeout-info'] = 'Un utilisateur est autoris&eacute; &agrave; modifier son message seulement durant les x secondes apr&egrave;s l\'avoir envoy&eacute; sur le forum.';
...
$lang['ConfigBoard-sendmail_sender_parameter'] = 'Autoriser le param&egrave;tre sendmail -f.';
$lang['ConfigBoard-sendmail_sender_parameter-info'] = 'Ceci peut bloquer les fonctionnalit&eacute;s e-mail chez certains h&eacute;bergeurs.';
$lang['ConfigBoard-antispam_question_mode'] = 'Mode question anti-spam';
$lang['ConfigBoard-antispam_question_mode-info'] = 'Ceci pose une question aux invit&eacute;s avant qu\'ils n\'aient acc&egrave;s &agrave; l\'enregistrement, aux nouveaux sujets et aux formulaires de r&eacute;ponses.';
$lang['ConfigBoard-antispam_question_mode0'] = 'D&eacute;sactiv&eacute;';
$lang['ConfigBoard-antispam_question_mode1'] = 'Question math&eacute;matique al&eacute;atoire';
$lang['ConfigBoard-antispam_question_mode2'] = 'Au hasard parmis les questions de votre choix';
$lang['ConfigBoard-antispam_question_questions'] = 'Questions anti-spam de votre choix';
$lang['ConfigBoard-antispam_question_questions-info'] = 'Questions sous forme de &quot;question|r&eacute;ponse&quot; (sans les guillemets) s&eacute;par&eacute;es par des retours &agrave; la ligne. La r&eacute;ponse est insensible &agrave; la casse.';
...
$lang['ForumsIncreasePostCount'] = 'Augmenter le compteur de messages des utilisateurs';
...
$lang['Forums-auth4'] = 'Editer les autres messages';
$lang['Forums-auth5'] = 'D&eacute;placer les sujets';
$lang['Forums-auth6'] = 'Supprimer les sujets et les messages';
...
$lang['MembersEditingLevelModInfo'] = 'Pour rendre quelqu\'un mod&eacute;rateur, &eacute;ditez un forum et ajoutez son nom d\'utilisateur dans la case pr&eacute;vue pour &ccedil;a.';
...
$lang['PruneMembersTypeNeverPosted'] = 'Membres qui n\'ont jamais &eacute;crit de messages';
